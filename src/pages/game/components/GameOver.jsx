...
const GameOver = ({ gameStatus, playAgain, score, time }) => {
        ...
        <div className='d-flex flex-column align-items-center justify-content-center position-fixed w-100 h-100'
            ...
            <div className="text-center mx-3 d-flex flex-column">
                ...
                <span className="text-white"
                    ...
                    Has conseguido {score} punto{score === 1 ? "" : "s"} en un tiempo de {time} segundos.</span>
    ...
    return gameStatus == 2 ? gameOverRender : null;
}
